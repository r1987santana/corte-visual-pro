...
export function getModuleKeyFromPath(pathname: string): AIModuleKey {
  if (pathname.startsWith("/dashboard-ceo") || pathname.startsWith("/pruebas-fabrica") || pathname.startsWith("/ceo") || pathname.startsWith("/contabilidad") || pathname.startsWith("/dashboard-financiero") || pathname.startsWith("/pagos")) return "dashboard_ceo";
